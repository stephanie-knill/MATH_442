...
How many labelled trees exist with 6 vertices such that the degree of ever vertex is 1 or 3?

Since we can only have vertices of degree 1 or 3, this gives us one possible configuration: two vertices of degree 3 attached with vertices of degree 1 on the remaining edges (Figure \ref{q60}).
...
\hl{ask stephanie: isomorphic or non-isomorphic???}
